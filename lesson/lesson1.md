...
- Реализуйте класс `com.javatest.webapp.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
```
- Протестируйте вашу реализацию с помощью классов `com.javatest.webapp.MainArray.main()` и `com.javatest.webapp.MainTestArrayStorage.main()`
...
6. `com.javatest.webapp.model.Resume r` — давай переменным осмысленные имена, например `resume`. `r` допустимо в коротких циклах и лямбдах.
...
1. Не меняйте сигнатуры методов в `com.javatest.webapp.storage.ArrayStorage`
